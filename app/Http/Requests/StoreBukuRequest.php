...
class StoreBukuRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if ($this->kategori === 'Programming' && $this->bahasa !== 'Inggris') {
                $validator->errors()->add('bahasa', 'Buku kategori Programming harus berbahasa Inggris.');
            }

            // Conditional: jika tahun < 2000, stok maksimal 5
            if ($this->tahun_terbit < 2000 && $this->stok > 5) {
                $validator->errors()->add('stok', 'Buku terbitan sebelum tahun 2000 maksimal stok 5.');
            }
        });
    }
