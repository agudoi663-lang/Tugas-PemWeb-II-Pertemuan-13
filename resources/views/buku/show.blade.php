            ...
            <div class="card-body">
                ...
                @else
                    ...
                    <p class="text-muted fst-italic">
                        <i class="bi bi-info-circle"></i> Tidak ada deskripsi
                    </p>
                @endif
    ...
    <div class="col-md-4">
        ...
        <div class="card mb-3">
            <div class="card-header bg-info text-white">
                <h6 class="mb-0"><i class="bi bi-info-circle"></i> Status Stok</h6>
            </div>
            <div class="card-body">
                @if ($buku->stok == 0)
        ...
        <div class="card">
            <div class="card-header bg-dark text-white">
                <h6 class="mb-0"><i class="bi bi-collection"></i> Buku Serupa</h6>
            </div>
            <div class="card-body">
                @php
