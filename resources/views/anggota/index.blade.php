            ...
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    <select name="pekerjaan" class="form-select">
                        ...
                        <option value="Pegawai Swasta" {{ request('pekerjaan') == 'Pegawai Swasta' ? 'selected' : '' }}>Pegawai Swasta</option>
                        <option value="Wiraswasta" {{ request('pekerjaan') == 'Wiraswasta' ? 'selected' : '' }}>Wiraswasta</option>
                        <option value="Dosen" {{ request('pekerjaan') == 'Dosen' ? 'selected' : '' }}>Dosen</option>
                    </select>
                </div>
                <div class="col-md-3">
